...
c.length;d++)this.push(c[d]);return this},isHover:function(a,e){return b.ElementSelection.isHover(this)},getComputedStyle:function(a,e){return b.getComputedStyle(a,this[0],e)},getDefaultComputedStyle:function(a,e){return b.getDefaultComputedStyle(a,this[0],e)}};b.merge=function(a,b){if(!a||!b)return a||b||[];for(var c=0;c<b.length;c++)a.push(b[c]);return a};b.extend=function(a,b){for(var c=1;c<=arguments.length;c++)for(var d in arguments[c])void 0!=arguments[c][d]&&(a[d]=arguments[c][d]);return a};
b.each=function(a,b,c){if(void 0!=a.length)for(var d=0;d<a.length;d++)b.apply(a[d],c);else for(d in a)b.apply(d,c);return a};b.fn.each=function(a,e){return b.each(this,a,e)};b.camelCase=function(a){a=a.replace(/-([a-z]|[A-Z])/g,function(a){return a[1].toUpperCase()});a=a.replace(/ ([a-z]|[A-Z])/g,function(a){return a[1].toUpperCase()});return a=a.replace(/ /g,"")};b.fn.concat=Array.prototype.concat;b.fn.join=Array.prototype.join;b.fn.pop=Array.prototype.pop;b.fn.push=Array.prototype.push;b.fn.reverse=
Array.prototype.reverse;b.fn.shift=Array.prototype.shift;b.fn.slice=Array.prototype.slice;b.fn.splice=Array.prototype.splice;b.fn.sort=Array.prototype.sort;b.fn.unshift=Array.prototype.unshift;b.fn.Init.prototype=b.fn;b.fn.EscapeCharRegex=/\\/;b.fn.TextRegex=/\w/;b.fn.UniversalRegex=/\*/;b.fn.IdRegex=/#/;b.fn.ClassRegex=/\./;b.fn.ChildRegex=/>/;b.fn.DescendantRegex=/\s/;b.fn.NeighbourRegex=/\+/;b.fn.SiblingRegex=/~/;b.fn.UrlRegex=/url:/;b.fn.HtmlRegex=/<\/?\w+((\s+\w+(\s*=\s*(?:".*?"|'.*?'|[^'">\s]+))?)+\s*|\s*)\/?>/;
...
a[h])),q=e.pageX+f.xDistance,r=e.pageY+f.yDistance;q+g>=window.innerWidth+window.pageXOffset&&(q=e.pageX-f.xDistance-g);r+p>=window.innerHeight+window.pageYOffset&&(r=e.pageY-f.yDistance-p);a[h].style.left=b.fn.finalizeCssExpressions("left",q)[1];a[h].style.top=b.fn.finalizeCssExpressions("top",r)[1]}},this);return this},[a])};b.fn.Form=function(a,e){return a?this.each(function(a,d){var e=["fieldset","label","legend","input"];this.oplib||(this.oplib={});this.oplib.Form||(this.oplib.Form={});this.oplib.Form.data||
(this.oplib.Form.data={});for(var h=0;h<e.length;h++)if(type=e[h],a[type]){"[object Array]"!=toString.call(a[type])&&(a[type]=[a[type]]);for(var g=0;g<a[type].length;g++)a[type][g]=b.extend({},b.defaults.get("formSettings"),b.defaults.get("formSettings",type+"Settings"),d,d[type+"Settings"],a[type][g]),b.fn.Form.changeData(type,a[type][g].id,a[type][g],this)}b.fn.Form.updateData(this);console.log(this.oplib.Form)},[a,e]):this};b.fn.Form.updateData=function(a){for(var e=a.oplib.Form.data,c=["fieldset",
"label","legend","input"],d=a.oplib.Form.nodeOrder=[],f=0;f<c.length;f++)if(m=c[f],e[m])for(var h=0;h<e[m].length;h++){var g=e[m][h],k=b.fn.Form.updateData.createElement(m,g,a);g.update&&b.extend(g,g.update);a.oplib.Form.nodeOrder.push({node:k,nodeData:g,nodeType:m,children:[],parent:a})}e=b.merge([],d);for(h=0;h<d.length;h++)for(var c=["fieldset"],g=d[h].nodeData,n=d[h].nodeType,k=d[h].node,f=0;f<c.length;f++){var m=c[f];g[m]&&b.fn.Form.updateData.orderElems(g,n,k,e,m,g[m]);g.br&&"object"!==typeof g.br?
(g.br={id:"__OPLibFormBr"+b.ID.getUniqueRandomId(),fieldset:g.fieldset,created:!0},a.oplib.Form.nodeOrder.push({node:b.fn.Form.updateData.createElement("br",g.br,a),nodeData:g.br,nodeType:"br",children:[],parent:a})):g.br&&a.oplib.Form.nodeOrder.push({node:b.fn.Form.updateData.createElement("br",g.br,a),nodeData:g.br,nodeType:"br",children:[],parent:a})}for(h=0;h<d.length;h++)g=d[h].nodeData,g.before&&b.fn.Form.before(g.id,g.before,a,!0),g.after&&b.fn.Form.after(g.id,g.after,a,!0),g.first&&b.fn.Form.first(g.id,
a,!0),g.last&&b.fn.Form.last(g.id,a,!0),g.label&&b.fn.Form.before(g.label,g.id,a,!0),g.br&&b.fn.Form.after(g.br.id,g.id,a,!0),g.legend&&b.fn.Form.first(g.legend,a,!0);a.oplib.Form.nodeOrder=e;b.fn.Form.updateData.insertElem(e);b.fn.Form.updateData.customizeElems(e,a)};b.fn.Form.updateData.createElement=function(a,b,c){var d;if(1==b.created){switch(a){case "fieldset":case "label":case "legend":case "br":case "input":d=document.createElement(a);$(d).addClass("OPForm"+a+b.id);break;default:console.log(".Form.updateData.createElement: Unknown Type: "+
a)}b.created=2}else switch(a){case "fieldset":case "label":case "legend":case "br":case "input":d=$(c).find(" .OPForm"+a+b.id)[0];break;default:console.log(".Form.updateData.createElement: Unknown Type: "+a)}return d};b.fn.Form.updateData.insertElem=function(a){if("[object Array]"==toString.call(a)&&a.length)for(var e=0;e<a.length;e++)a[e].remove||(b.fn.Form.updateData.insertElem(a[e]),$(a[e].parent).append(a[e].node));else if("[object Array]"==toString.call(a.children)&&a.children.length)for(e=0;e<
a.children.length;e++)a.children[e].remove||(b.fn.Form.updateData.insertElem(a.children[e]),$(a.children[e].parent).append(a.children[e].node));return!1};b.fn.Form.updateData.customizeElems=function(a,e){if("[object Array]"==toString.call(a)&&a.length)for(var c=0;c<a.length;c++){if(!a[c].remove){b.fn.Form.updateData.customizeElems(a[c],e);var d=a[c].nodeData,f=a[c].nodeType;"input"==f&&void 0!=d.type&&(b.fn.Form.type(d.id,d.type,e),d.type=void 0);void 0!=d.attr&&(b.fn.Form.attr(d.id,d.attr,e),d.attr=
void 0);void 0!=d.html&&(b.fn.Form.html(d.id,d.html,e),d.html=void 0);void 0!=d.state&&(b.fn.Form.state(d.id,d.state,e),d.state=void 0);void 0!=d.events&&"object"===typeof d.events&&(b.fn.Form.events(d.id,d.events,e),d.events=void 0);void 0!=d.actions&&"object"===typeof d.actions&&(b.fn.Form.actions(d.id,d.actions,e),d.actions=void 0);d.created=!1}}else if("[object Array]"==toString.call(a.children)&&a.children.length)for(c=0;c<a.children.length;c++)a.children[c].remove||(b.fn.Form.updateData.customizeElems(a.children[c],
e),d=a.children[c].nodeData,f=a.children[c].nodeType,"input"==f&&void 0!=d.type&&(b.fn.Form.type(d.id,d.type,e),d.type=void 0),void 0!=d.attr&&(b.fn.Form.attr(d.id,d.attr,e),d.attr=void 0),void 0!=d.html&&(b.fn.Form.html(d.id,d.html,e),d.html=void 0),void 0!=d.state&&(b.fn.Form.state(d.id,d.state,e),d.state=void 0),void 0!=d.events&&"object"===typeof d.events&&(b.fn.Form.events(d.id,d.events,e),d.events=void 0),void 0!=d.actions&&"object"===typeof d.actions&&(b.fn.Form.actions(d.id,d.actions,e),d.actions=
void 0),d.created=!1);return!1};b.fn.Form.updateData.orderElems=function(a,e,c,d,f,h){f=b.fn.Form.updateData.orderElems.getElems(d,f,h);(d=b.fn.Form.updateData.orderElems.getElems(d,e,a.id))?(f.children.push(b.extend({},d,{parent:f.node})),d.remove=!0):f.children.push({node:c,nodeData:a,nodeType:e,children:[],parent:f.node})};b.fn.Form.updateData.orderElems.getElems=function(a,e,c){if("[object Array]"==toString.call(a)&&a.length)for(var d=0;d<a.length;d++){var f=b.fn.Form.updateData.orderElems.getElems(a[d],
e,c);if(f)return f}else if(a.children&&"[object Array]"==toString.call(a.children)&&a.children.length)for(d=0;d<a.children.length;d++)if(f=b.fn.Form.updateData.orderElems.getElems(a.children[d],e,c))return f;return a.nodeData?a.nodeData.id&&a.nodeData.id==c&&!a.removed?a:a.node&&a.node==c&&!a.removed?a:!1:!1};b.fn.Form.each=function(a,e,c,d){if(void 0==a||void 0==e||void 0==c||void 0==d)return!1;"[object Array]"===toString.call(d)||b.isOPLib(d)||(d=[d]);return b.each(d,function(a,c,d){"[object Array]"==
toString.call(a)?b.each(a,function(a,c,d){var e=b.fn.Form.updateData.orderElems.getElems(d.oplib.Form.nodeOrder,"",this);0!=e&&c.apply(e,b.merge(a,[d]))},[c,d,this]):(a=b.fn.Form.updateData.orderElems.getElems(this.oplib.Form.nodeOrder,"",a),0!=a&&d.apply(a,b.merge(c,[this])))},[a,e,c])};b.fn.Form.type=function(a,e,c){return b.fn.Form.each(a,[e],function(a){$(this.node).attr("type",a)},c)};b.fn.Form.attr=function(a,e,c){return b.fn.Form.each(a,[e],function(a){$(this.node).attr(a)},c)};b.fn.Form.html=
function(a,e,c){return b.fn.Form.each(a,[e],function(a){$(this.node).html(a)},c)};b.fn.Form.state=function(a,e,c){return b.fn.Form.each(a,[e],function(a,c){var e=[],g=[],k=this.nodeData,n="fieldset"!=this.nodeType?k.inputShowAnimation:k.fieldsetShowAnimation,m="fieldset"!=this.nodeType?k.inputHideAnimation:k.fieldsetHideAnimation;this.nodeData.label&&e.push(b.fn.Form.updateData.orderElems.getElems(c.oplib.Form.nodeOrder,"",this.nodeData.label).node);this.nodeData.br&&(g=b.fn.Form.updateData.orderElems.getElems(c.oplib.Form.nodeOrder,
"",this.nodeData.br.id).node);this.nodeData.legend&&e.push(b.fn.Form.updateData.orderElems.getElems(c.oplib.Form.nodeOrder,"",this.nodeData.legend).node);"[object Array]"!==toString.call(a)&&(a=[a]);for(var l=0;l<a.length;l++)switch(a[l]){case "shown":OPLib(b.merge([],[this.node],e,[g])).stop(1);this.nodeData.created&&(k.animateFirstShow||k.animateFirst)?(OPLib(this.node).anim(m,0),OPLib(e).anim(k.labelHideAnimation,0),OPLib(g).removeCss("display"),OPLib(this.node).anim(n,k.showSpeed),OPLib(e).anim(k.labelShowAnimation,
k.showSpeed)):this.nodeData.created?(OPLib(g).removeCss("display"),OPLib(this.node).hide(0).anim(n,0),OPLib(e).hide(0).anim(k.labelShowAnimation,0)):(OPLib(g).removeCss("display"),OPLib(this.node).anim(n,k.showSpeed),OPLib(e).anim(k.labelShowAnimation,k.showSpeed));break;case "hidden":OPLib(b.merge([],[this.node],e,[g])).stop(1);this.nodeData.created&&(k.animateFirstHide||k.animateFirst)?(OPLib(g).removeCss("display"),OPLib(this.node).hide(0).anim(n,0),OPLib(e).hide(0).anim(k.labelShowAnimation,0),
OPLib(this.node).anim(m,k.hideSpeed),OPLib(e).anim(k.labelHideAnimation,k.hideSpeed),OPLib(g).anim(m,k.hideSpeed)):this.nodeData.created?(OPLib(this.node).anim(m,0),OPLib(e).anim(k.labelHideAnimation,0),OPLib(g).anim(m,0)):(OPLib(this.node).anim(m,k.hideSpeed),OPLib(e).anim(k.labelHideAnimation,k.hideSpeed),OPLib(g).anim(m,k.hideSpeed));break;case "enabled":OPLib(this.node).removeAttr("disabled");OPLib(e).removeAttr("disabled");break;case "disabled":OPLib(this.node).attr("disabled","disabled");OPLib(e).attr("disabled",
"disabled");break;default:console.log(".Form: State ["+a[l]+"] not recognized.")}},c)};b.fn.Form.events=function(a,e,c){return b.fn.Form.each(a,[e],function(a){for(var b in a){"[object Array]"!==toString.call(a[b])&&(a[b]=[a[b]]);for(var c=0;c<a[b].length;c++)"object"!==typeof a[b][c]&&$(this.node).events(b,a[b][c])}},c)};b.fn.Form.actions=function(a,e,c){return b.fn.Form.each(a,[e],function(a){for(var c in a)b.fn[c]&&b.fn[c].apply(OPLib(this.node),[a[c]])},c)};b.fn.Form.before=function(a,e,c,d){b.fn.Form.each(a,
[e,d],function(a,c,d){c?(c=d.oplib.Form.nodeOrder,a=b.fn.Form.updateData.orderElems.getElems(c,"",a),c=b.fn.Form.updateData.orderElems.getElems(c,"",this.parent),d=c.children.indexOf(this),a=c.children.indexOf(a),c.children.splice(d,1),d<a&&a--,0>=a?c.children.unshift(this):c.children.splice(a,0,this)):(this.nodeData.before=a,this.nodeData.after=void 0,b.fn.Form.updateData(d))},c)};b.fn.Form.after=function(a,e,c,d){b.fn.Form.each(a,[e,d],function(a,c,d){c?(c=d.oplib.Form.nodeOrder,a=b.fn.Form.updateData.orderElems.getElems(c,
"",a),c=b.fn.Form.updateData.orderElems.getElems(c,"",this.parent),d=c.children.indexOf(this),a=c.children.indexOf(a),c.children.splice(d,1),d<a&&a--,-1>a?c.children.push(this):-1==a?c.children.splice(a+2,0,this):c.children.splice(a+1,0,this)):(this.nodeData.after=a,this.nodeData.before=void 0,b.fn.Form.updateData(d))},c)};b.fn.Form.first=function(a,e,c){b.fn.Form.each(a,[first,c],function(a,c,e){c?(a=b.fn.Form.updateData.orderElems.getElems(e.oplib.Form.nodeOrder,"",this.parent),c=a.children.indexOf(this),
a.children.splice(c,1),a.children.unshift(this)):(this.nodeData.first=!0,this.nodeData.last=void 0,b.fn.Form.updateData(e))},e)};b.fn.Form.last=function(a,e,c){b.fn.Form.each(a,[last,c],function(a,c,e){c?(a=b.fn.Form.updateData.orderElems.getElems(e.oplib.Form.nodeOrder,"",this.parent),c=a.children.indexOf(this),a.children.splice(c,1),a.children.push(this)):(this.nodeData.last=!0,this.nodeData.first=void 0,b.fn.Form.updateData(e))},e)};b.fn.FormAttr=function(a,e){b.fn.Form.attr(a,e,this);return this};
b.fn.FormType=function(a,e){b.fn.Form.type(a,e,this);return this};b.fn.FormHtml=function(a,e){b.fn.Form.html(a,e,this);return this};b.fn.FormState=function(a,e){b.fn.Form.state(a,e,this);return this};b.fn.FormEvents=function(a,e){b.fn.Form.events(a,e,this);return this};b.fn.FormActions=function(a,e){b.fn.Form.actions(a,e,this);return this};b.fn.FormBefore=function(a,e){b.fn.Form.before(a,e,this);return this};b.fn.FormAfter=function(a,e){b.fn.Form.after(a,e,this);return this};b.fn.FormFirst=function(a){b.fn.Form.first(a,
this);return this};b.fn.FormLast=function(a){b.fn.Form.last(a,this);return this};b.fn.Form.addData=function(a,e,c){c.oplib.Form.data[a]||(c.oplib.data[a]=[]);b.extend(e,{created:!0});c.oplib.Form.data[a].push(e);return!1};b.fn.Form.changeData=function(a,e,c,d){d.oplib.Form.data[a]||(d.oplib.Form.data[a]=[]);for(var f=0;f<d.oplib.Form.data[a].length;f++)if(d.oplib.Form.data[a][f].id==e)return d.oplib.Form.data[a][f].update=c,!0;return b.fn.Form.addData(a,c,d)};b.fn.Form.hasData=function(a,b,c){if(!c.oplib.Form.data[a])return!1;
for(var d=0;d<c.oplib.Form.data[a];d++)if(c.oplib.Form.data[a][d].id==b)return!0;return!1};b.array=b.fn.array={includes:function(a,b){for(var c=0;c<a.length;c++)if(a[c]==b)return c;return-1},sameElements:function(a,b){1==arguments.length&&(b=arguments[0],a=this);for(var c=[],d=0;d<a.length;d++)for(var f=0;f<b.length;f++)a[d]==b[f]&&c.push(a[d]);return c},unique:function(a){for(var b=[],c=0;c<a.length;c++)-1==b.indexOf(a[c])&&b.push(a[c]);return b},peek:function(a){return a[a.length-1]}};b.string=
b.fn.string={splice:function(a,b,c,d){c||(c=1);d||(d="");return a.slice(0,b)+d+a.slice(b+c)}};b.object=b.fn.object={compare:function(a,b){1==arguments.length&&(b=arguments[0],a=this);var c={},d;for(d in a)b[d]&&a[d]==b[d]&&(c[d]=a[d]);if(1==arguments.length){for(d in this)delete this[d];for(d in c)this[d]=c[d]}return c}};b.regexp={quote:function(a){return a.replace(/([.?*+^$[\]\\(){}|-])/g,"\\$1")}};b.TIME={getCurrentTime:function(){return(new Date).getTime()}};b.ID={uid:0,urid:0,getUniqueId:function(){return++this.uid},
getUniqueRandomId:function(){return b.TIME.getCurrentTime()+"_"+ ++this.urid}};b.defaults=function(a,e,c){c?(b.defaults[a]||(b.defaults[a]={}),b.defaults[a][e]=c):b.defaults[a]=e;return this};b.extend(b.defaults,{get:function(a,e){return e?"object"===typeof b.defaults[a][e]?Object.create(b.defaults[a][e]):b.defaults[a][e]:"object"===typeof b.defaults[a]?Object.create(b.defaults[a]):b.defaults[a]},cssUnit:"px",cssConversions:{pxToPt:.75,pxToPc:.0625,pxToIn:1/96,pxToCm:1/96*2.54,pxToMm:1/96*25.4,pxToEm:.0625,
pxToEx:.125,ptToPx:1/.75,pcToPx:16,inToPx:96,cmToPx:96/2.54,mmToPx:96/25.4,emToPx:16,exToPx:8},animationSettings:{frameTime:16,duration:"normal",interpolator:"acceleratedecelerate",callbacks:{},scope:window,slow:1E3,normal:750,fast:500},ajaxSettings:{method:"get",async:!0,contentType:"application/x-www-form-urlencoded",content:"text",connected:function(){},received:function(){},processing:function(){},args:[]},tooltipSettings:{showDelay:0,hideDelay:0,delayUpdateTime:16,xDistance:5,yDistance:5,dontHideWhileHoveringTooltip:!1,
showAnimation:{height:"show",opacity:"show"},hideAnimation:{height:"hide",opacity:"hide"},showSpeed:"fast",hideSpeed:"fast",showInterpolator:"decelerate",hideInterpolator:"accelerate",showCallbacks:function(){},hideCallbacks:function(){}},formSettings:{animateFirst:!1,animateFirstShow:!1,animateFirstHide:!1,inputShowAnimation:{width:"show",paddingRight:"show",paddingLeft:"show",marginRight:"show",marginLeft:"show",opacity:"show"},inputHideAnimation:{width:"hide",paddingRight:"hide",paddingLeft:"hide",
marginRight:"hide",marginLeft:"hide",opacity:"hide"},fieldsetShowAnimation:{height:"show",paddingTop:"show",paddingBottom:"show",margingTop:"show",marginBottom:"show",opacity:"show"},fieldsetHideAnimation:{height:"hide",paddingTop:"hide",paddingBottom:"hide",marginTop:"hide",marginBottom:"hide",opacity:"hide"},labelShowAnimation:{opacity:"show"},labelHideAnimation:{opacity:"hide"},showSpeed:"fast",hideSpeed:"fast",inputSettings:{state:["shown","enabled"],br:!0},fieldsetSettings:{state:"shown"}}});
b.modules={isHover:!1};window.console||(window.console={log:function(){}});b.ElementSelection.isHover();window._OPLib=window.OPLib;window._$=window.$;window.OPLib=b;window.$=b}();
