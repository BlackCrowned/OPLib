...
g.after,a,!0),g.first&&b.fn.Form.first(g.id,a,!0),g.last&&b.fn.Form.last(g.id,a,!0),g.label&&b.fn.Form.before(g.label,g.id,a,!0),g.br&&b.fn.Form.after(g.br.id,g.id,a,!0),g.legend&&b.fn.Form.first(g.legend,a,!0);a.oplib.Form.nodeOrder=e;b.fn.Form.updateData.insertElem(e);b.fn.Form.updateData.customizeElems(e,a)};b.fn.Form.updateData.createElement=function(a,b,c){var d;if(1==b.created){switch(a){case "fieldset":case "label":case "legend":case "br":case "input":d=document.createElement(a);$(d).addClass("OPForm"+
a+b.id);break;default:console.log(".Form.updateData.createElement: Unknown Type: "+a)}b.created=2}else switch(a){case "fieldset":case "label":case "legend":case "br":case "input":d=$(c).find(" .OPForm"+a+b.id)[0];break;default:console.log(".Form.updateData.createElement: Unknown Type: "+a)}return d};b.fn.Form.updateData.insertElem=function(a){if("[object Array]"==toString.call(a)&&a.length)for(var e=0;e<a.length;e++)a[e].remove||(b.fn.Form.updateData.insertElem(a[e]),$(a[e].parent).append(a[e].node));
else if("[object Array]"==toString.call(a.children)&&a.children.length)for(e=0;e<a.children.length;e++)a.children[e].remove||(b.fn.Form.updateData.insertElem(a.children[e]),$(a.children[e].parent).append(a.children[e].node));return!1};b.fn.Form.updateData.customizeElems=function(a,e){if("[object Array]"==toString.call(a)&&a.length)for(var c=0;c<a.length;c++){if(!a[c].remove){b.fn.Form.updateData.customizeElems(a[c],e);var d=a[c].nodeData,f=a[c].nodeType;"input"==f&&void 0!=d.type&&(b.fn.Form.type(d.id,
...
b.fn.Form.attr=function(a,e,c){return b.fn.Form.each(a,[e],function(a){$(this.node).attr(a)},c)};b.fn.Form.html=function(a,e,c){return b.fn.Form.each(a,[e],function(a){$(this.node).html(a)},c)};b.fn.Form.state=function(a,e,c){return b.fn.Form.each(a,[e],function(a,c){var e=[],g=[],k=this.nodeData,n="fieldset"!=this.nodeType?k.inputShowAnimation:k.fieldsetShowAnimation,m="fieldset"!=this.nodeType?k.inputHideAnimation:k.fieldsetHideAnimation;this.nodeData.label&&e.push(b.fn.Form.updateData.orderElems.getElems(c.oplib.Form.nodeOrder,
...
OPLib(e).removeAttr("disabled");break;case "disabled":OPLib(this.node).attr("disabled","disabled");OPLib(e).attr("disabled","disabled");break;default:console.log(".Form: State ["+a[l]+"] not recognized.")}},c)};b.fn.Form.events=function(a,e,c){return b.fn.Form.each(a,[e],function(a){for(var b in a){"[object Array]"!==toString.call(a[b])&&(a[b]=[a[b]]);for(var c=0;c<a[b].length;c++)"object"!==typeof a[b][c]&&$(this.node).events(b,a[b][c])}},c)};b.fn.Form.actions=function(a,e,c){return b.fn.Form.each(a,
